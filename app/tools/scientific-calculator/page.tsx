    ...
    >
      <div
        style={{
          ...
          margin: "0 auto",
          display: "grid",
          gridTemplateColumns: "minmax(0, 1.15fr) minmax(320px, 0.6fr)",
          gap: 24,
        }}
      >
        <div
          style={{
            ...
            boxShadow: "0 24px 60px rgba(30, 41, 59, 0.14)",
        ...
        >
          <div
            style={{
              ...
              background:
                "linear-gradient(135deg, rgba(255,192,0,0.18), rgba(72,129,255,0.10))",
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Advanced mathematical calculations with a polished interface,
                  scientific functions, memory tools, and real-time evaluation.
                </p>
              </div>
          ...
          <div style={{ padding: 24 }}>
            ...
            >
              ...
              <div
                style={{
                  marginTop: 8,
                  textAlign: "right",
                  color: livePreview && livePreview !== "Error" ? "#8de1a5" : "#c8d2e2",
                  minHeight: 22,
                  fontWeight: 600,
                }}
              >
            ...
            >
              ...
              <div style={{ color: "#516076", lineHeight: 1.8 }}>
                <div>• Trigonometric functions use the selected angle mode.</div>
                <div>• Use <strong>xʸ</strong> for powers and <strong>√</strong> for roots.</div>
                <div>• <strong>log</strong> means base 10 and <strong>ln</strong> means natural logarithm.</div>
                <div>• Factorial works for non-negative integers only.</div>
                <div>• Supported functions: sin, cos, tan, asin, acos, atan, log, ln, sqrt, abs, exp.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div
          style={{
            ...
            backdropFilter: "blur(18px)",
            boxShadow: "0 24px 60px rgba(30, 41, 59, 0.12)",
            border: "1px solid rgba(255,255,255,0.75)",
            overflow: "hidden",
            display: "flex",
        ...
        >
          ...
          >
            <div>
              ...
              >
                Reuse previous expressions and results.
              </p>
            </div>
          ...
          <div style={{ padding: 20, flex: 1 }}>
            {showHistory ? (
              history.length > 0 ? (
                ...
                >
                  No calculations yet. Start using the scientific keys to build
                  expressions, then press <strong>=</strong>.
                </div>
              )
            ) : (
              <div
            ...
            >
              ...
              <div style={{ color: "#516076", lineHeight: 1.8 }}>
                <div>• Example: <strong>sin(30)+log(100)</strong></div>
                <div>• Example: <strong>sqrt(25)+5^2</strong></div>
                <div>• Example: <strong>3!+2^3</strong></div>
                <div>• Example: <strong>asin(0.5)</strong></div>
              </div>
            </div>
          </div>
        </div>
